...
# source: masking_analysis/protos/masking_config.proto
...
SingleBand = _reflection.GeneratedProtocolMessageType('SingleBand', (_message.Message,), dict(
  ...
  __module__ = 'masking_analysis.protos.masking_config_pb2'
